...
<#--                    <img src="<@resource src=options['site_logo']/>" alt="hongshan"/>-->
<#--                </a>-->
            ...
            <div class="gh-foot-min-back hidden-xs hidden-sm">
                <!-- 请保留此处标识-->
                <span class="footer-nav-item">Powered by <a href="https://github.com/JamesHardense/hongshan" target="_blank">红山开源</a></span>
            </div>
        </div>
    </div>
</footer>
