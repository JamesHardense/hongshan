            ...
            <div class="col-xs-12 col-md-12">
                <div class="form-group">
                    <div class="text-right">
                        <button type="button" data-status="0" class="btn btn-success" event="post_submit" style="padding-left: 30px; padding-right: 30px;">发布</button>
                    </div>
                </div>
            </div>
            <h3>词条名称</h3>
        ...
        <div class="col-xs-12 col-md-4 side-right">
            ...
            <div class="text-right">
                ...
                <div class="text-center"  >
                    <button type="button" id="popup" data-status="0" class="btn btn-success" style="padding-left: 100px; padding-right: 100px;">词条参考信息抽取</button>
                </div>
